  ...
  Object.defineProperty(this, 'provider', {
    ...
    set: function(value) {
      if (Item.isValidProvider(value)) {
        ...
        throw new Error('Provider must be null or a function that takes exactly one argument (a callback): ' + toString.call(value) + ' provided');
      }
    }
  });
...
Item.prototype.callProvider = function(callback, options) {
  var _this = this,
    wrapped = function() {
      if (timeoutProvider) {
